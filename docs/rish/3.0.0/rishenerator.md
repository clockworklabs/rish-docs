...
_Note: This page is intended as a reference to understand the system internals. You should always use Rishenerator in your projects._
...
_Reserved Keywords: To avoid conflicts in the generated factory methods, the following names are reserved and should not be used as Prop fields:
- `key`: Always reserved for Element Keys.
- `name`, `className` and `style`: Reserved in VisualElements and RishElements with expanded `DOMDescriptors`.
- `children`: Reserved in VisualElements.
