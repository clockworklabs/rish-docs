...
- `VisualAttributes textInputDescriptor`: Styling information for the `TextInput` child. Expanded in `Create` method.
- `VisualAttributes textElementDescriptor`: Styling information for the `TextElement` child. Expanded in `Create` method.
